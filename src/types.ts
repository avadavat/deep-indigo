...
export namespace LeftoversAgainTypes {
  export interface AI {
  ...
  interface Battle {
    constructor(bid: string, connection: Connection, botpath: string): Battle;
  ...
  interface Challenger {
    ...
    constructor(scrappy: boolean, format: string): Challenger;
  ...
  interface Decision {
    ...
    constructor(id: number | string | object, target: number): Decision;
  }
  ...
  interface Lobby {
    constructor(scrappy: boolean, format: string): Lobby;
  ...
  interface Monkey extends Connection {}

  interface MOVE extends Decision {
    constructor(id: number | string | object, target?: number): Decision;
  ...
  interface Pokemon {
    constructor(ident: string, details: string): Pokemon;
  ...
  interface SWITCH extends Decision {
    constructor(id: number | string | object, target?: number): SWITCH;
  }

  interface Team {
    constructor(tm: Array<Pokemon> | string): Team;
  ...
  type botFinder = (path: string) => object; // TODO
  //   function botFinder(path: string): object; // TODO

  type start = (metadata: object, Bot: AI) => object; // TODO
